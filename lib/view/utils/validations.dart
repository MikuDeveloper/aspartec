class FormValidations {
  ...
  static final RegExp _phoneNumberRegExp =
      RegExp(r'^\(\d{3}\)\s?\d{3}\-\d{4}$');

  static const String _emptyMessage = 'Ingrese algún valor';
  static const String _emailMessage = 'Correo electrónico inválido';
  static const String _passwordMessage =
      'Ingrese al menos 6 caracteres entre\nmayúsculas, '
      'minúsculas, números y alguno\nde los siguientes caracteres'
      ' especiales:\n!, @, #, %, &, /, *, ~, -, _, .';
  static const String _phoneNumberMessage =
      'Ingrese un número de celular de 10 dígitos';
